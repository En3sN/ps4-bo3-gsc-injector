...
namespace PS4_BO3_GSC
{
    public partial class MainWindow : MetroForm
    {
        ...
        private Enums.ConsoleVersion selectedConsoleVersion = Enums.ConsoleVersion.eleven;
        ...
        private void updateSelectedConsoleVersion()
        {
            ...
            else if (savedVersion == Enums.ConsoleVersion.nine)
                nineRadioButton.Checked = true;
            else if (savedVersion == Enums.ConsoleVersion.eleven)
                elevenRadioButton.Checked = true;
        }
        ...
        private string getPayloadFileForVersion()
        {
            ...
            switch (selectedConsoleVersion)
            {
                ...
                case Enums.ConsoleVersion.nine:
                    return $"{payloadsDirectory}\\9_00\\{payloadFileName}";
                case Enums.ConsoleVersion.eleven:
                    return $"{payloadsDirectory}\\11_00\\{payloadFileName}";
                default:
        ...
        private void nineRadioButton_CheckedChanged(object sender, EventArgs e)
        {
            RadioButton radioButton = (RadioButton)sender;
            if (radioButton.Checked)
                updateConsoleVersion(Enums.ConsoleVersion.nine);
        }

        private void elevenRadioButton_CheckedChanged(object sender, EventArgs e)
        {
            RadioButton radioButton = (RadioButton)sender;
            if (radioButton.Checked)
                updateConsoleVersion(Enums.ConsoleVersion.eleven);
        }
